...
var require_sjcl = __commonJS({
  "node_modules/sjcl/sjcl.js"(exports, module) {
    ...
    sjcl.mode.gcm = { name: "gcm", encrypt: function(a, b, c, d, e) {
      ...
      var d, e = c.length;
      b = b.slice(0);
      for (d = 0; d < e; d += 4) b[0] ^= 4294967295 & c[d], b[1] ^= 4294967295 & c[d + 1], b[2] ^= 4294967295 & c[d + 2], b[3] ^= 4294967295 & c[d + 3], b = sjcl.mode.gcm.ka(b, a);
      return b;
    }, C: function(a, b, c, d, e, f) {
