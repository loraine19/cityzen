...
export default function EventDetailPage() {
    ...
    const [eventLoad, setEvent] = useState<EventView>(event || {} as EventView);
    ...
    const buttons: Action[] = [
        {
            ...
            function: async () => eventLoad.toogleParticipate && setEvent(await eventLoad.toogleParticipate())
        },
        {
    ...
    return (
        <div className="Body cyan">
            ...
            <main>
                {!loadingEvent ?
                    <EventDetailCard Event={eventLoad} setEvent={setEvent} /> :
