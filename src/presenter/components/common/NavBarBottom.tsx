        ...
        <>
            ...
            <footer
                ...
                className={
                    ...
                    ((navBottom) ? `items-center pb-2 bottom-0 transform-y-0 opacity-100 anim ${color}BG backdropBlur w-respXl rounded-full justify-center` : 'pt-2 fixed left-1/2 -translate-x-1/2 -top-1.5 z-0 scale-90  w-[calc(100%-10rem)] lg:!max-w-[calc(1000px-8rem)] -ml-2 items-start !justify-start') +
                    ` flex gap-6`
                }>

                <Navbar className={`${navBottom ? 'min-w-max !max-w-[calc(100vw-8rem)] w-full' : ' overflow-x-auto lg:overflow-hidden !max-w-[calc(100%-7rem)]'} -ml-4  shadow-md overflow-auto flex rounded-full h-full items-center p-0 !bg-white/95 border border-blue-gray-100/50`}>
