...
export function EventForm(props: { formik: any, setValue: (value: string) => void }) {
    ...
    const address: Address = formik.values.Address
                            ...
                            <div className='CardOverFlow gap-3'>
                                ...
                                <div className='flex flex-col lg:flex-row gap-5 pt-3 h-full'>
                                    ...
                                    <div className="flex flex-1 flex-col  ">
                                        ...
                                        <MapPickUpComp address={newAddress} setAddress={setNewAddress}
                                            text={Address && Address?.address + " " + Address?.zipcode + " " + Address?.city} inputStyle />
