...
export default function NavBarBottom(props: { handleClick?: () => void, addBtn?: boolean }) {
    ...
    return (
        <footer className="pt-0.5 pb-2 px-2">
            ...
            >
                ...
                <div className={addBtn ? "flex p-2" : "hidden"}>
                    <SpeedDial offset={10}>
                        <SpeedDialHandler >
                            <Button size="sm" color="cyan" className="flex items-center justify-center  rounded-full h-12 w-12" >
                        ...
                        <SpeedDialContent>
                            <SpeedDialAction className="h-14 gap-4 w-14 shadow-lg" title={`Ajouter un ${type}`} onClick={onclick}>
                                <span className="material-symbols-rounded text-cyan-500">edit</span>
                                <div
                                    className=
