...
import CalendarComp from "../calendarComps/CalendarComp";
...
import { Icon, NotifBadge } from "../UIX/SmallComps";
import { logOut } from "../../data/api/useApi";
...
export default function DashboardPage() {
    const { userProfile, userNotif, notifList } = useContext(UserContext)
    ...
    useEffect(() => {
        const fetch = async () => {
            if (!userProfile) window.location.replace('/signup_details')
